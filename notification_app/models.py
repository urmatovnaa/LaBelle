...
class Notification(models.Model):
    ...
    from_user = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True,
    ...
    # statement describing the notification (ex: "Aliya sent you a friend request")
